// ── architect-galaxy-tick/narrativeMode.ts ───────────────────────────────────
// Verbatim copy of src/shared/narrative/narrativeMode.ts — edge functions
// cannot import from src/. Guarded by the twinParity CODE_TWINS test; edit the
// src copy and re-sync, never this one.
