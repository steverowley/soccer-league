// ── KEEP IN SYNC WITH supabase/functions/match-worker/applyFanBoost.ts ──────────
...
//   diff supabase/functions/match-worker/applyFanBoost.ts supabase/functions/shadow-match-worker/applyFanBoost.ts
