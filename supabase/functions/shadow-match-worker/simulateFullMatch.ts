// ── KEEP IN SYNC WITH supabase/functions/match-worker/simulateFullMatch.ts ──────────
...
//   diff supabase/functions/match-worker/simulateFullMatch.ts supabase/functions/shadow-match-worker/simulateFullMatch.ts
