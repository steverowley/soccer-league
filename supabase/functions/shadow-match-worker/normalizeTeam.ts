// ── KEEP IN SYNC WITH supabase/functions/match-worker/normalizeTeam.ts ──────────
...
//   diff supabase/functions/match-worker/normalizeTeam.ts supabase/functions/shadow-match-worker/normalizeTeam.ts
