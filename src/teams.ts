...
//
// HOW PERSONALITY IS ASSIGNED (in createAgent, gameEngine.ts)
// ────────────────────────────────────────────────────────────
...
const TEAMS: Record<string, EngineTeam> = {
  // ── Mars United ─────────────────────────────────────────────────────────────
  ...
  mars: {
    ...
    players: [
      ...
      // Second backup DF — provides defensive depth without burning the midfield sub.
  ...
  saturn: {
    ...
    players: [
      ...
      // Second backup DF — mirrors Mars United's bench depth for equivalent tactical flexibility.
